...
problem.states.x0=[x_0  y_0  v  lambda_0];

% Initial conditions for system. Bounds if x0 is free s.t. x0l=< x0 <=x0u
problem.states.x0l=[x_0  y_0  v -10]; 
problem.states.x0u=[x_0  y_0  v 10]; 
...
problem.states.xfl=[0   0  -10 -10]; 
problem.states.xfu=[10 10  10  10];
