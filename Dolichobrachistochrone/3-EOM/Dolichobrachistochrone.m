...
problem.states.x0=[1.5 1.5 -1.25];

% Initial conditions for system. Bounds if x0 is free s.t. x0l=< x0 <=x0u
problem.states.x0l=[1.5 1.5 -10 ]; 
problem.states.x0u=[1.5 1.5  10]; 



% State bounds. xl=< x <=xu
problem.states.xl=[0  0 -10 ];
problem.states.xu=[20 20 10 ];
