function options = settings_Dolichobrachistochrone(varargin)
...
%          When giving one input with varargin, e.g. with settings(20),
%               will use h-method of your choice with N=20 nodes
%          When giving two inputs with varargin, hp-LGR method will be 
%               used with two possibilities
%           - Scalar numbers can be used for equally spaced intervals 
%               with the same polynoimial orders. For example, 
%               settings_hp(5,4) means using 5 LGR intervals each of 
%               polynomial degree of 4. 
%           - Alternatively, can supply two arrays in the argument with 
%                 customized meshing. For example, 
%                 settings_hp([-1 0.3 0.4 1],[4 5 3]) will have 3 segments 
%                 on the normalized interval [-1 0.3], [0.3 0.4] and
%                 [0.4 1], with polynomial order of 4, 5, and 3 respectively.
%      
% Output:
...
options.discretization='AutoDirect';
