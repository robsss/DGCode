function [problem,guess] = TwoDPE_ZBCU
%OrbitRaising
%
...
InternalDynamics=@TwoDPE_ZBCU_Dynamics_Internal;
SimDynamics=@TwoDPE_ZBCU_Dynamics_Sim;
...
% Settings file
problem.settings=@settings_TwoDPE_ZBCU;
...
problem.time.tf_min=45;     
problem.time.tf_max=45; 
guess.tf=45;
